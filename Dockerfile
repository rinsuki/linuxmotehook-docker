...
RUN apt-get update && apt-get install -y --no-install-recommends lua5.3 liblua5.3-dev lua5.3-lgi build-essential libreadline-dev unzip libxwiimote-dev lua-json wget cmake git gtk-3.0 && rm -rf /var/lib/apt/lists/*
